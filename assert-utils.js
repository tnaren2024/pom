 ...
 */
export const assertEquals = (actual, expected, failureMessage) => {
 ...
 * @param failureMessage Message to display if the assertion fails
 */
export const assertNotEquals = (actual, expected, failureMessage) => {
    const logMessage = `Assert; expected: ${expected} ;; actual: ${actual}`;
    startLog(logMessage);
    try {
 ...
 * @param failureMessage Message to display if the assertion fails
 */
export const assertTrue = (actual, failureMessage) => {
